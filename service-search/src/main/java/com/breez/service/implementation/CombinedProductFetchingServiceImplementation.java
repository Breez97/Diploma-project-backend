...
public class CombinedProductFetchingServiceImplementation implements CombinedProductFetchingService {

	private static final Logger logger = LoggerFactory.getLogger(CombinedProductFetchingServiceImplementation.class);
	...
	private String getProductsKey(String marketplaceId, String sessionId, String searchHash) {
		return String.format(REDIS_PRODUCTS_PREFIX, marketplaceId, sessionId, searchHash);
	}
