...
public class ProductsFetchingServiceImplementation implements ProductsFetchingService {

	private static final Logger logger = LoggerFactory.getLogger(ProductsFetchingServiceImplementation.class);
