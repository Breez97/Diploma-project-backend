...
public class Constants {
	...
	// Wildberries
	public static final String WILDBERRIES_BASE_URL = "https://search.wb.ru";

	public static final String WILDBERRIES_USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36";

	public static final String WILDBERRIES_X_CAPTCHA_ID = "Catalog 1|1|1744456262|AA==|3dead74d4f3f4973b5759f195d0702cd|6l373ADvEwKGWgqwMDeLv70lnbtSaRtuUrIzoHGpIiN";

	public static final int WILDBERRIES_PAGE = 1;

	// Общее
	public static final String WILDBERRIES_SEX_COMMON = "common";
	// Женское
	public static final String WILDBERRIES_SEX_FEMALE = "female";
	// Мужское
	public static final String WILDBERRIES_SEX_MALE = "male";
	...
	public static final int OZON_PAGE = 1;
	...
	// Дешевле
	public static final String OZON_SORT_CHEAPER = "price";
	// Дороже
